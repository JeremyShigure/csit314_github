...
public class SummaryOfUpdatedAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_summary_of_updated_account);
    ...
    public void goHome() {
        Intent intent = new Intent(SummaryOfUpdatedAccount.this, AdminMainPage.class);
