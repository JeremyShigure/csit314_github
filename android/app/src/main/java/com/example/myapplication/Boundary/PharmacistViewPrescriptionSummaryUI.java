...
public class PharmacistViewPrescriptionSummaryUI extends AppCompatActivity {
    ...
    public void tableCreate(String medicineName, int qty, String date){
        newTR = new TableRow(PharmacistViewPrescriptionSummaryUI.this);
        getMedicineName = new TextView(PharmacistViewPrescriptionSummaryUI.this);
        getQty = new TextView(PharmacistViewPrescriptionSummaryUI.this);
        getDate = new TextView(PharmacistViewPrescriptionSummaryUI.this);
