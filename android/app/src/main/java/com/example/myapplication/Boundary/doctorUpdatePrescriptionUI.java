...
public class doctorUpdatePrescriptionUI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_delete_prescription);
    ...
    public void DoctorViewPatientPrescription() {
        Intent intent = new Intent(doctorUpdatePrescriptionUI.this, DoctorViewPatientPrescriptionPage2.class);
        startActivity(intent);
    }

    public void goBack() {
        Intent intent = new Intent(doctorUpdatePrescriptionUI.this, doctorSearchThenAddUpdate.class);
        startActivity(intent);
    }
}