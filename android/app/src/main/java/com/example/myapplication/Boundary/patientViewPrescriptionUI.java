...
public class patientViewPrescriptionUI extends AppCompatActivity {
    ...
    public void tableCreate(String medicineName, int qty, String date){
        newTR = new TableRow(patientViewPrescriptionUI.this);
        getMedicineName = new TextView(patientViewPrescriptionUI.this);
        getQty = new TextView(patientViewPrescriptionUI.this);
        getDate = new TextView(patientViewPrescriptionUI.this);
